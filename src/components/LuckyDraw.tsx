        ...
        {isFreeDrawMode && (() => {
            ...
            if (isLayoutRow) {
              ...
              return (
                <motion.div style={{
                  ...
                  {first}
                  {btnPos === 'middle' && (
                    <div style={{ width: 0, height: 0, position: 'relative', alignSelf: 'center', zIndex: 50 }}>
          ...
          return (
            <div style={{
              ...
              {layoutEl}
              {!buttonFirst && btnPos !== 'middle' && controlsEl}
            </div>
          );
        })()}
        ...
        {!isFreeDrawMode && !isFocusMode && history.length > 0 && (
          <div className="flex justify-center mb-8">
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>Bạn có chắc muốn đặt lại toàn bộ?</AlertDialogTitle>
                  <AlertDialogDescription>
                    Toàn bộ lịch sử bốc thăm sẽ bị xóa. Không thể hoàn tác.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Hủy</AlertDialogCancel>
